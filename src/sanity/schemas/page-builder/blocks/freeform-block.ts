...
import {
    SpacingInput,
    spacingOptions,
} from "../../../components/spacing-input";
import {
    AlignmentInput,
    alignmentOptions,
} from "../../../components/alignment-input";
...
export default defineType({
    ...
    fields: [
            ...
            of: [
                {
                    ...
                    fields: [
                        ...
                        defineField({
                            ...
                            type: "string",
                            description:
                                "Add some default spacing between items (optional).",
                            options: {
                                list: spacingOptions.map(
        ...
        defineField({
            ...
            type: "string",
            description:
                "Display a border to seperate this block with blocks above and below.",
            options: {
                list: [
